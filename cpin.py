...
print(bigreen+f'Date : {x.day} - {x.strftime(bipurple+"%B")}-{x.year}, {x.strftime(biyellow+"%A")}')
print(f'Time: {x.strftime("%I")}:{x.strftime(biblue+"%M")}:{x.strftime(bicyan+"%S")} {x.strftime(bigreen+"%p")}')
...
if number=="01875184257":
    print('This Number Protact 01875184257')
elif number=="01616858069":
    print('This Number Protact 01616858069')    
elif number=="01875879289":
    print("This Number Protact 01875879289")

elif number=="01890106020":
	print("This Number Protact 01890106020")
elif number=="01890106020":
	print("This Number Protact 01890106020")
elif number=="01624991051":
	print("This Number Protact 01624991051")
elif number=="01844669707":
	print("This Number Protact 01844669707")
elif number=="01870631115":
	print("This Number Protact 01870631115")
elif number=="01833640837":
	print("This Number Protact 0183364837")
